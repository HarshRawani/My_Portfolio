...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # customized context_processors
                'portfolio.context_processors.resume',
            ],
        },
    },
]
...
DATABASES = {
    'default': dj_database_url.config(
        ...
        conn_health_checks=True, # Auto-reconnect on idle
    )
}
...
# Local fallback (used when ImageKit keys are not set)
MEDIA_URL  = '/media/'
